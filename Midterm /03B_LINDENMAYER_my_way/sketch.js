...
var numloops = 7; // how many iterations of the L-system to pre-compute
var therules = []; // array for rules
therules[0] = ['A', '-BBF+AFF+FB-']; // first rule
therules[1] = ['B', '+AF-FB-FA+']; // second rule
...
function drawIt(k)
{
  ...
  radius+= random(0, 15);
  radius+= random(0, 15);
  radius = radius/Math.floor(random(1,3));
